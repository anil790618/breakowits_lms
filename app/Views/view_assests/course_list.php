                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="card-body">
                                                <!-- Multi Columns Form -->
                                                <form class="row g-3" id="course_input_modal_form" method="post"  enctype="multipart/form-data">
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <textarea  rows="3" name="t_heading" id="t_heading" class="form-control"></textarea>
                                                    </div>
                                                    <div class="col-md-6">
