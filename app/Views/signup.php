          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                ...
                <img src="assets/img/light-logo.png" alt="" style="    max-height: 55px;" >
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo base_url(); ?>signup" method="post" name='form' class="row g-3 " >
                    <div class="col-12">
                      <label for="firstname" class="form-label">Your First name</label>
                      <input type="text" name="firstname" class="form-control" id="firstname" required  value="<?=set_value('firstname')?>" >
                      <!-- <input type="text" name="fname" class="form-control" id="fname" required  >
                      <div class="invalid-feedback">Please, enter your first name!</div> -->
                    </div>
                    <div class="col-12">
                      <label for="lastname" class="form-label">Your Last name</label>
                      <!-- <input type="text" name="lastname" class="form-" id="lastname"  value="<?=set_value('lastname')?>"> -->
                      <input type="text" name="lastname" class="form-control" id="lastname" required value="<?=set_value('lastname')?>">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="passconf" class="form-control" id="passconf"  value="<?=set_value('passconf')?>">
